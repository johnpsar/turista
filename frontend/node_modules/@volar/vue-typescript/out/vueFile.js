    ...
    const sfcTemplateCompiled = (0, reactivity_1.computed)(() => {
        ...
        if (sfc.template) {
            for (const plugin of plugins) {
                const compiledHtml = (_a = plugin.compileTemplate) === null || _a === void 0 ? void 0 : _a.call(plugin, sfc.template.content, (_b = sfc.template.lang) !== null && _b !== void 0 ? _b : 'html');
                if (compiledHtml) {
                    return {
                        lang: (_c = sfc.template.lang) !== null && _c !== void 0 ? _c : 'html',
